...
-- Bridge table between players and teams.
-- Generated by UNPIVOT of the 22 lineup columns in match
-- (home_player_1..11 and away_player_1..11) to convert them into rows.
